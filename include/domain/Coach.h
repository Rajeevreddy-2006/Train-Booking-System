//#ifndef #define #endif ensure that a header file is included only once, preventing redefinition errors.
...
public:
    ...
    // int assignSeat(); //auto assign seat
    ...
    int getAvailableSeats(const std::string& journeyDate) const;
